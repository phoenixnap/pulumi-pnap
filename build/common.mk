...
ifeq ($(NOPROXY), true)
	...
	@echo "cd provider && GO111MODULE=on GOPROXY=$(GOPROXY) go mod download"; cd provider && GO111MODULE=on go mod download
	...
	@echo "cd scripts && GO111MODULE=on GOPROXY=$(GOPROXY)  go mod download"; cd scripts && GO111MODULE=on go mod download
endif
